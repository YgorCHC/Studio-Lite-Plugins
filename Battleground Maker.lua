...
GenerateButton.MouseButton1Click:Connect(function()
	...
	local function PPRGUU_fake_script() -- Bar.LocalScript 
		local script = Instance.new('LocalScript', Bar)

		-- StarterGui.ScreenGui.MagicHealth.Health.Bar.LocalScript was not decompiled because the option is off. -Zyrc
	end
	coroutine.wrap(PPRGUU_fake_script)()
	local function RALW_fake_script() -- TextLabel.LocalScript 
		local script = Instance.new('LocalScript', TextLabel)

		-- StarterGui.ScreenGui.MagicHealth.TextLabel.LocalScript was not decompiled because the option is off. -Zyrc
	end
	coroutine.wrap(RALW_fake_script)()
