...
Instance.new('Folder', workspace).Name = 'All_Scripts_91'
...
GenerateButton.MouseButton1Click:Connect(function()
	...
	if workspace.All_Scripts_91:FindFirstChildWhichIsA('Script') and workspace:FindFirstChildWhichIsA('LocalScript') and workspace:FindFirstChildWhichIsA('ModuleScript') then
		...
		local function CreateLocalScript(Name:string, Codigo:string, parent:Object)
			local NewScript = workspace.All_Scripts_91.LocalScript:Clone()
			NewScript.Name = Name
		...
		local M1Script = CreateLocalScript('M1Script', [[
				...
				MobileHudFoda10.Parent = game.Players.LocalPlayer.PlayerGui
				local combat1 = Instance.new("ImageButton",MobileHudFoda10)
				combat1.Name = "combat"
				combat1.HoverImage = ''
				...
				combat1.Size = UDim2.new(0.181, 0,0.242,0)
				combat1.Position  =UDim2.new(0.873, 0, 0.394,0)
				combat1.BackgroundTransparency = 1

				Instance.new('UIAspectRatioConstraint', combat1)
		...
		Warn1.Parent = SG
		Warn1.Visible = true
		Warn1.Text = 'Coloque todos os tipos de script na pasta "All_Scripts_91"'
		game.Debris:AddItem(Warn1, 1.3)
